...
module.exports = function () {
    ...
    let privateKey = fs.readFileSync('/etc/letsencrypt/live/dgd-oipa.blue4you.be/privkey.pem', 'utf8');
    let certificate = fs.readFileSync('/etc/letsencrypt/live/dgd-oipa.blue4you.be/fullchain.pem', 'utf8');
