...
$(document).ready(function() {
    (function(global, undefined){
        ...
        if(map) {
            ...
            consol
            var url = "https://18.221.72.54:8000/activities/?format=json&reporting_organisation="+document.reportingOrgs+"&hierarchy=1&recipient_country=" + countryCode + "&fields=title,iati_identifier,locations&page_size=500&activity_status=2";
